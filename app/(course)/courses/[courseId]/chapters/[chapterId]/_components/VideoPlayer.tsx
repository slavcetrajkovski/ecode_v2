...
const VideoPlayer = ({
  ...
  return (
    <div className="relative aspect-video">
      ...
      {isLocked && (
        <div className="absolute inset-0 flex items-center justify-center bg-ecode_primary flex-col gap-y-2 text-secondary">
          <Lock className="h-8 w-8" />
          <p className="text-sm">Ова поглавје е заклучено</p>
        </div>
      )}
      {!isLocked && (
        <MuxPlayer
